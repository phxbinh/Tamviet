...
export default function ProductDetailClient({ data }: { data: ProductFull }) {
  ...
  return (
    <div className="max-w-[1400px] mx-auto grid grid-cols-1 lg:grid-cols-12 gap-6 xl:gap-20 py-6 px-6 animate-fade-in custom-scrollbar items-start">
      
      {/* LEFT: VISUAL (Fixed Aspect Ratio 4/5) */}
      <div className="lg:col-span-7 w-full">
        <div className="sticky top-12 space-y-6">
          <div className="relative aspect-[4/5] bg-card rounded-[0.25rem] overflow-hidden border border-border shadow-sm group">
