...
export default function CheckoutForm() {
  ...
  return (
    <form 
      ...
      className="max-w-2xl mx-auto p-6 space-y-4 bg-card border border-border rounded-2xl shadow-xl transition-colors duration-300"
    >
      <h2 className="text-xl font-bold text-primary mb-6 tracking-wide uppercase">
        Thông tin nhận hàng
      </h2>
