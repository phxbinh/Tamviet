...
<div className="flex-1 overflow-y-auto custom-scrollbar flex flex-col bg-transparent">
  
  <main className="flex-1 p-2 md:p-8 w-full max-w-6xl mx-auto shrink-0 overflow-x-visible">
    {children}
  </main>
