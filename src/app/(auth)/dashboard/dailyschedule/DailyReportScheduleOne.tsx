...
const MOCK_DAILY_REPORTSS: DailyReportItem[] = [
  {
    id: 'rpt-01',
    userId: 'u1',
...
const MOCK_DAILY_REPORTS: DailyReportItem[] = [
  ...
  },
  {
    ...
    title: 'Viết API lấy danh sách task',
    description: 'Xây dựng endpoint REST trả về danh sách task theo user.',
    startTime: '08:30',
    endTime: '09:30',
    status: 'done',
    priority: 'high',
  ...
  },
  {
    ...
    userId: 'u2',
    userName: 'Nguyễn Minh',
    title: 'Tối ưu query dashboard',
    description: 'Giảm thời gian load dashboard bằng cách thêm index.',
    startTime: '09:30',
    endTime: '11:00',
    status: 'in_progress',
    priority: 'high',
  ...
  },
  {
    ...
    userId: 'u3',
    userName: 'Linh Trần',
    title: 'Thiết kế UI Card Report',
    description: 'Thiết kế card hiển thị báo cáo ngày cho dashboard.',
    startTime: '08:00',
    endTime: '09:00',
    status: 'done',
    priority: 'medium',
  ...
  },
  {
    ...
    userId: 'u3',
    userName: 'Linh Trần',
    title: 'Refactor component ProgressBar',
    description: 'Tách component progress bar dùng chung cho task và report.',
    startTime: '11:00',
    endTime: '12:00',
    status: 'pending',
    priority: 'low',
  ...
  },
  {
    ...
    description: 'Kết nối Supabase Auth với hệ thống role admin.',
    startTime: '13:00',
    endTime: '15:00',
    status: 'in_progress',
    priority: 'urgent',
  ...
  },
  {
    ...
    userId: 'u4',
    userName: 'Hoàng Phúc',
    title: 'Fix bug redirect login',
    description: 'Sửa lỗi redirect vòng lặp sau khi login thành công.',
    startTime: '15:00',
    endTime: '16:00',
    status: 'blocked',
    priority: 'high',
    progress: 30,
    isApproved: false,
    adminComment: 'Đang chờ cập nhật middleware mới.',
    tags: ['bugfix'],
  },
  {
    id: 'rpt-09',
    ...
    description: 'Viết documentation cho các endpoint report.',
    startTime: '09:00',
    endTime: '10:30',
    status: 'pending',
    priority: 'medium',
  ...
  },
  {
    ...
    userId: 'u5',
    userName: 'Quang Huy',
    title: 'Test hệ thống report',
    description: 'Test các trạng thái pending / done / blocked.',
    startTime: '16:00',
    endTime: '17:00',
    status: 'done',
    priority: 'low',
