  ...
  return (
    <div className="flex flex-col lg:flex-row gap-4 items-center w-full">
      ...
      <div className="relative w-full lg:w-44">
        ...
        <select
          className="w-full bg-background border border-border pl-9 pr-8 py-2 rounded-full text-[10px] font-bold uppercase tracking-wider appearance-none cursor-pointer focus:ring-1 focus:ring-primary outline-none transition-all hover:border-primary/50"
