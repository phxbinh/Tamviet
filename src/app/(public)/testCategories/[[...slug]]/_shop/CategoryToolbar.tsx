...
export function CategoryToolbar_({ categories, currentPath }: Props) {
        ...
        {categories.map((cat, i) => {
          ...
          return (
            <Link
              ...
              // 🔥 CHỈ PREFETCH 8 ITEM ĐẦU
              prefetch={i < 8}

              // 🔥 CÒN LẠI → hover mới prefetch
              onMouseEnter={() => {
                if (i >= 8) handlePrefetch(href);
              }}
              onTouchStart={() => {
                if (i >= 8) handlePrefetch(href);
              }}
