...
<div className="grid gap-2 grid-cols-[repeat(auto-fit,minmax(160px,1fr))] p-2 rounded-2xl bg-secondary/40 border border-border/50"> {/* Giảm khoảng cách giữa các nhóm thuộc tính */}
  {attributes.map((attr) => (
