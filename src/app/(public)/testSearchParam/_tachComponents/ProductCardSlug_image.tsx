      ...
      <div className="relative aspect-[4/5] overflow-hidden bg-[#fafafa]">
        {thumbnail_url ? (
          <Image
            src={thumbnail_url}
            alt={name}
            // 2. Sử dụng fill để ảnh tràn đầy khung aspect-ratio của cha
            fill
            // 3. Sizes giúp Next.js chọn đúng kích thước ảnh cho từng thiết bị
            sizes="(max-width: 768px) 100vw, (max-width: 1200px) 50vw, 33vw"
            className="object-cover will-change-transform transition-transform duration-[2.5s] ease-[cubic-bezier(0.165,0.84,0.44,1)] group-hover:scale-[1.03]"
            // 4. Ưu tiên tải nếu đây là danh sách sản phẩm đầu trang
            priority={false} 
          />
        ) : (
